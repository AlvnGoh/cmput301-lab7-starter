...
import static androidx.concurrent.futures.ListenableFutureKt.await;
...
// You can also use anything() in place of is(instanceOf(String.class))
    ...
    public void testBackButton(){
        ...
        // Click on Confirm
        onView(withId(R.id.button_confirm)).perform(click());
        //Click on the item in city listview
        onData(anything())
        ...
        //check if the city listview is displayed to check if the back button worked
    ...
    public void testShowActivity(){
        ...
        // Click on Confirm
        onView(withId(R.id.button_confirm)).perform(click());
        //Click on an item in the city listview
        onData(anything())
                .inAdapterView(withId(R.id.city_list))
                .atPosition(0)
                .perform(click());
        //Check the city name TextView is displayed
